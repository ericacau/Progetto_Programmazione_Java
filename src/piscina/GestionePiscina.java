...
public class GestionePiscina {
   ...
   /* controlla che la data inserita non corrisponda ai giorni di chiusura settimanali
    ...
    private boolean controllaTemperatura(double temperatura) {
        ...
        do {
            try {
                if ((temperatura >= 37) && (temperatura <= 41)) { // se la temperatura è >= 37, non e' consentito l'ingresso
                    //temperaturaOK = false;
                ...
                // se la temperatura è troppo alta o troppo bassa, si inserisce nuovamente la temperatura
    ...
    //visualizza gli incassi di uno specifico mese inserito dall'utente
